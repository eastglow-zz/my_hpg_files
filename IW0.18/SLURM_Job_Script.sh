#!/bin/sh
#SBATCH --job-name=IW0.18            #Job name
...
srun --mpi=pmix_v1 /home/donguk.kim/projects/wetting/wetting-opt -i /home/donguk.kim/projects/wetting/InterWidthTest/IW0.18/INS_MPCH_coupled_IW0.18.i
