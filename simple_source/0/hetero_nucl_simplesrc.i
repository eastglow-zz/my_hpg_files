...
[Materials]
  ...
  [./Material_properties] #Sets the material properties of the material
    ...
    prop_values = '0.055 0.52 270.5 32 0.01 1000 1    8.37707e-7  0.0   0'
  [../]
  [./Model_parameters]
    type = GenericConstantMaterial
    prop_names =  'L0   delta'
  ...
  [./cBeq_temp_dep]
    type = ParsedMaterial
    material_property_names = 'kb T Ef dcB'
    args = 'channel'
    constant_names =       'Sf'
    constant_expressions = '4.7'
    function = 'exp(Sf)*exp(-Ef/kb/T) + dcB*channel' #From Frank et al. PRL 1996
    f_name = cBeq
    outputs = exodus
  [../]
