...
#SBATCH --output=c4-%j.out #Output and error log name
...
srun --mpi=pmix_v3 $APPPATH/combined-opt -i ./hetero_nucl_simplesrc.i Materials/Material_properties/prop_values='0.055 0.52 270.5 32 0.01 1000 1    8.37707e-7  0.0   1e-1'
