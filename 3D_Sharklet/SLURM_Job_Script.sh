#!/bin/sh
#SBATCH --job-name=Shark3D            #Job name
#SBATCH --nodes=8                   #Number of nodes (servers, 32 proc/node)
#SBATCH --ntasks=256                 #Number of tasks/How many parallel jobs to run
...
srun --mpi=pmix_v1 /home/donguk.kim/projects/wetting/wetting-opt -i ./INS_MPCH_coupled_Sharklet3Dsym.i
